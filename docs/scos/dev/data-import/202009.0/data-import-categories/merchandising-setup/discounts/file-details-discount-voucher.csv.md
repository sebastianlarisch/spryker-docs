...
originalLink: https://documentation.spryker.com/v6/docs/file-details-discount-vouchercsv
originalArticleId: 3615d558-b57d-4ac0-abbb-f67ef5fd367b
redirect_from:
  - /v6/docs/file-details-discount-vouchercsv
  - /v6/docs/en/file-details-discount-vouchercsv
---
...
| **custom_code** | Yes | String |N/A | Customized code of the voucher, composed by two parts:<ul><li>a prefix of the voucher code that can be set directly in this field,</li><li>a random part with the amount of random symbols equals to the value of random_generated_code_length field.</li></ul> |
