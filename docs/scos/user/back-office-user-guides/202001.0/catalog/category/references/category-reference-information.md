...
To use such a template, the Templates & Slots feature should be [integrated](/docs/scos/dev/feature-integration-guides/{{page.version}}/cms-feature-integration-guide.html) into your project.
